    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.houserentappproject.House1 house1 = new com.example.houserentappproject.House1(mname, mnumber, mtype, mrent, mcity);
                referencene.setValue(com.example.rent_haven.House1);
